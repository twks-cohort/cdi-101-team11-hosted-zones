...
provider "aws" {
  alias  = "subdomain_prod_us_east_1_cdicohorts_team11"
  region = "us-east-1"
  assume_role {
...
module "subdomain_prod_us_east_1_cdicohorts_team11" {
  source  = "terraform-aws-modules/route53/aws//modules/zones"
  version = "2.0.0"
  create  = true

  providers = {
    aws = aws.subdomain_prod_us_east_1_cdicohorts_team11
  }

  zones = {
    "prod-us-east-1.${local.domain_cdicohorts_team11}" = {
      tags = {
        cluster = "prod"
      }
    }
...
module "subdomain_zone_delegation_prod_us_east_1_cdicohorts_team11" {
  ...
  records = [
    {
      ...
      records         = lookup(module.subdomain_prod_us_east_1_cdicohorts_team11.route53_zone_name_servers,"prod-us-east-1.${local.domain_cdicohorts_team11}")
    }
  ]

  depends_on = [module.subdomain_prod_us_east_1_cdicohorts_team11]
}
