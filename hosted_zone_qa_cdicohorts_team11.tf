...
provider "aws" {
  alias  = "subdomain_qa_cdicohorts_team11"
  region = "us-east-1"
  assume_role {
...
module "subdomain_qa_cdicohorts_team11" {
  source  = "terraform-aws-modules/route53/aws//modules/zones"
  version = "2.0.0"
  create  = true

  providers = {
    aws = aws.subdomain_qa_cdicohorts_team11
  }

  zones = {
    "qa.${local.domain_cdicohorts_team11}" = {
      tags = {
        cluster = "prod"
      }
    }
...
module "subdomain_zone_delegation_qa_cdicohorts_team11" {
  ...
  records = [
    {
      ...
      records         = lookup(module.subdomain_qa_cdicohorts_team11.route53_zone_name_servers,"qa.${local.domain_cdicohorts_team11}")
    }
  ]

  depends_on = [module.subdomain_qa_cdicohorts_team11]
}
